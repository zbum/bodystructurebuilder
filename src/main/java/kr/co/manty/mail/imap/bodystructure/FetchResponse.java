...
public final class FetchResponse implements ImapResponseMessage {
    ...
    public FetchResponse(int messageNumber, Flags flags, Long modSeq, Date internalDate, Long size, Envelope envelope, Structure body, Structure bodystructure, List<BodyElement> elements) {
        super();
